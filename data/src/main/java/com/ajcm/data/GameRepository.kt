...
interface GameRepository {
    ...
    fun updateMovement(chessPiece: Piece, newPosition: Position, playerRequest: Player = whoIsMoving())
    fun updateTurn()
    ...
    fun getPossibleMovementsOf(chessPiece: Piece, playerRequest: Player = whoIsMoving()): List<Position>
